...
function Navbar() {
    ...
    const headerBg = shouldApplyScrollStyles && isProjectPage && scrolled ? "bg-white dark:bg-black transition-colors duration-200" : shouldApplyScrollStyles && isAboutPage && scrolled ? "glass-blur transition-all duration-500 no-color-transition" : shouldApplyScrollStyles && isWorksPage && scrolled ? "glass-blur glass-blur-lg-off transition-all duration-500 no-color-transition" : "";
...
"[project]/src/components/layout/HeadingReveal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HeadingReveal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (prefersReducedMotion) {
            headings.forEach((heading)=>heading.classList.add("heading-reveal-visible"));
            return;
        }
        const observer = new IntersectionObserver((entries)=>{
            entries.forEach((entry)=>{
                ...
                target.classList.add("heading-reveal-visible");
        ...
        headings.forEach((heading)=>{
            ...
            heading.dataset.headingReveal = "true";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__58bd4e3a._.js.map