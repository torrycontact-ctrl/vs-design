export default function FooterSection() {
  return (
    <footer className="fixed inset-x-0 bottom-6 z-40 bg-transparent px-[var(--container-padding-mobile)] lg:px-[var(--container-padding-desktop)]">
      <div className="mx-auto flex max-w-[var(--max-w-desktop)] flex-col items-center gap-4 lg:flex-row lg:justify-between">
        {/* Availability status badge */}
        <div className="slide-in-right flex h-9 items-center justify-center gap-2 rounded-[6px] bg-[var(--color-gray-50)] px-3 dark:bg-[var(--color-neutral-800)]">
