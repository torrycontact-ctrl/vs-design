    ...
    imageBlocks: [
      {
        type: "single",
        images: [
          { src: "/images/Work/teams/1.png", alt: "dot.Teams dashboard overview", width: 3840, height: 2304 },
        ],
      },
      {
        type: "double",
        images: [
          { src: "/images/Work/teams/31.png", alt: "dot.Teams member management", width: 1860, height: 1800 },
          { src: "/images/Work/teams/32.png", alt: "dot.Teams client portal", width: 1860, height: 1800 },
        ],
      },
      {
        type: "single",
        images: [
          { src: "/images/Work/teams/2.png", alt: "dot.Teams design system components", width: 3840, height: 2304 },
        ],
      },
    ],
    resultsGalleryWidths: [512, 576, 320, 384],
